...
"""
kmeans.fit(features)
pred_cluster = kmeans.predict(features)
"""
...
"""
https://kapilddatascience.wordpress.com/2015/12/08/k-mean-clustering-using-silhouette-analysis-with-example-part-3/
"""
...
#WIth above values, we can clearly see that the optimal cluster values are 5
