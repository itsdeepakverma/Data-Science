...
# STEP 1
#c.execute("CREATE DATABASE employeeeee;")
...
# adding the employee in the employees collection
...
def add_employee(idd, first, last, pay):
    ...
    unique_employee = mydb.mycollection.find_one({"id":idd})
    if unique_employee:
        return "Employee already exists"
    else:
